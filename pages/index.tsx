  ...
  function Home() {
    ...
    return (
      <main className="flex flex-col p-12">
        ...
        <div className='my-7 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700'>
          <h1>Popular Decks</h1>

        </div>
        <div className='my-1 block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700'>
